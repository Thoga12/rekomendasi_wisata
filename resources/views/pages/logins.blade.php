                ...
                @endif
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" placeholder="Masukan Email" name="email"
                            class="w-full px-4 py-3 rounded border-1 border-white focus:outline-none focus:ring-1 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="text-right mb-6">
                        <a href="/register" class="text-white text-sm hover:underline">Belum Memiliki Akun</a>
                    </div>

                    <!-- Login Button -->
                    <button
                        class="w-full bg-blue-500 hover:bg-blue-700 text-white py-3 rounded font-medium transition duration-300">
                        Login
                    </button>
                </div>
            </form>
