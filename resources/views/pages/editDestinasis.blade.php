        ...
        <main class="p-6">
            <div class="max-w-4xl mx-auto">
                    ...
                    <div class="px-6 py-4 border-b">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h1 class="text-2xl font-bold text-gray-900">Edit Wisata</h1>
                                    <p class="text-sm text-gray-600 mt-1">Perbarui informasi destinasi wisata</p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-2 text-sm text-gray-500">
                                <i class="fas fa-clock"></i>
                                <span>Terakhir diupdate: {{ $wisata->updated_at ?? 'Belum pernah' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <form action="{{ route('destinations.update', $destination->id ?? 1) }}" method="POST" enctype="multipart/form-data" id="formEditWisata">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" id="nama_destinasi" name="name" required
                                               value="{{ old('name', $destination->name ?? 'Pantai Indah') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="lokasi" name="region" required
                                               value="{{ old('lokasi', $destination->region ?? 'Kendari') }}"
                                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                    ...
                                    {{-- <div>
                                        ...
                                        <select id="kategori" name="kategori_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                                            <option value="">Pilih Kategori</option>
                                            <option value="1" {{ old('kategori_id', $wisata->kategori_id ?? 1) == 1 ? 'selected' : '' }}>Pantai</option>
                                            <option value="2" {{ old('kategori_id', $wisata->kategori_id ?? '') == 2 ? 'selected' : '' }}>Gunung</option>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="number" id="latitude" name="latitude" step="any" required
                                               value="{{ old('latitude', $destination->latitude ?? '-3.9778') }}"
                                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="longitude" name="longitude" step="any" required
                                               value="{{ old('longitude', $destination->longitude ?? '122.5194') }}"
                                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                        ...
                        <div class="flex items-center justify-between p-6 bg-gray-50 border-t">
                            ...
                            <div class="flex items-center space-x-4">
                                <a href="{{ route('destinations.index') }}" class="px-6 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
